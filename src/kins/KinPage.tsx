  ...
  return (
    <div className="KinPage">
      ...
      <div className='content'>
        ...
        <div>To help in selection, on the left is the Myrr Kin and on the right is the 13th age SRD equivalent. If you are not using a race from the core rulebook, it will likely not be in Foundry and you'll have to port the power over. I can help with any settings required to make it function properly.</div>
